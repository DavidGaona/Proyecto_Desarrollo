...
public class DbManager {
    ...
    public String payPlan(int phoneNumber) {
        String payPlanQueryRemove = "DELETE FROM active_bills WHERE client_id = ?";
        String payPlanQueryAdd = "Insert INTO legacy_bills() values";
