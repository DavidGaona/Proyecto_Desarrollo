...
public class ClientMenu {
    ...
    private HBox topBar(HBox hBox, double width, double height) {
        ...
        searchPane.getSearchField().setOnAction(e -> {
            ...
            if (searchedClient.isNotBlank()) {
                ...
                personalInfo.setTextField("clientCity", searchedClient.getCity());
        ...
        menuCircle.setOnMouseClicked(e -> signOut.display());

        hBox.getChildren().addAll(menuCircle, newClientButton, icons.getSearchIcon(), saveChangesButton);
    ...
    private void saveNewClient() {
        ...
        if (!personalInfo.isEmpty()) {
            message = client.saveNewClient(
                    ...
                    ProjectUtilities.clearWhiteSpaces(personalInfo.getContent("clientCity")),
    ...
    private void personalInfo(double width) {
        ...
        personalInfo.addTextField("clientCity", "Ciudad:");
        personalInfo.addCharacterLimit(256, "clientCity");
